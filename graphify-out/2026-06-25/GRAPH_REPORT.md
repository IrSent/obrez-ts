...
## Knowledge Gaps
- **97 isolated node(s):** `SPEEDS`, `DIST_DIR`, `PUBLIC_DIR`, `SRC_DIR`, `clients` (+92 more)
...
- **What connects `SPEEDS`, `DIST_DIR`, `PUBLIC_DIR` to the rest of the system?**
