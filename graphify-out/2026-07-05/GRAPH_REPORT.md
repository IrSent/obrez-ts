# Graph Report - obrez-ts  (2026-07-04)

## Corpus Check
- 54 files · ~101,079 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 319 nodes · 469 edges · 45 communities (34 shown, 11 thin omitted)
...
8. `DbRecord` - 8 edges
9. `scripts` - 7 edges
10. `BleepSoundManagerInner()` - 7 edges
...
## Knowledge Gaps
- **106 isolated node(s):** `DIST_DIR`, `PUBLIC_DIR`, `SRC_DIR`, `clients`, `server` (+101 more)
