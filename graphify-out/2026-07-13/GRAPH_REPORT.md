# Graph Report - obrez-ts  (2026-07-13)

## Corpus Check
- 78 files · ~115,624 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 515 nodes · 763 edges · 57 communities (42 shown, 15 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `190f1dce`
...
Cohesion: 0.13
Nodes (21): TopupModal(), TopupModalProps, BleepSoundManager, Plan, PlanCard, PlanCardProps, PLANS, SettingsModal() (+13 more)
...
Cohesion: 0.08
Nodes (14): AddWordModal, AddWordModalProps, EffectBadge, EffectModal, EffectModalProps, closestRef, highlightCache, highlightSearch (+6 more)
...
- **Why does `FastAhoScanner` connect `Dictionary + Aho-Corasick` to `Community 30`?**
