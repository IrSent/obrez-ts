# Graph Report - obrez-ts  (2026-07-11)

## Corpus Check
- 78 files · ~115,282 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 507 nodes · 752 edges · 57 communities (42 shown, 15 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `066f395f`
...
## Knowledge Gaps
- **203 isolated node(s):** `versionIdx`, `DIST_DIR`, `PUBLIC_DIR`, `SRC_DIR`, `clients` (+198 more)
