...
## Corpus Check
- 79 files · ~116,080 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 518 nodes · 769 edges · 56 communities (41 shown, 15 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4bb3c2a1`
...
Cohesion: 0.06
Nodes (52): ConfirmationModal(), ConfirmationModalProps, formatDuration(), LoginModal(), LoginModalProps, TopupModal(), TopupModalProps, BleepSoundManager (+44 more)
...
## Knowledge Gaps
- **206 isolated node(s):** `DEFAULT_DICTIONARIES`, `LoginModalProps`, `ErrorEntry`, `TabKey`, `TABS` (+201 more)
...
- **What connects `DEFAULT_DICTIONARIES`, `LoginModalProps`, `ErrorEntry` to the rest of the system?**
