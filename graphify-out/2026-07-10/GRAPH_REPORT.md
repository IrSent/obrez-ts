...
## Corpus Check
- 77 files · ~113,877 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 509 nodes · 746 edges · 58 communities (42 shown, 16 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 10 edges (avg confidence: 0.89)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `19b05a8f`
...
## Knowledge Gaps
- **206 isolated node(s):** `Core Types`, `Transcription`, `Dictionaries`, `Censoring Effects`, `Bleep Sounds` (+201 more)
...
- **What connects `Core Types`, `Transcription`, `Dictionaries` to the rest of the system?**
