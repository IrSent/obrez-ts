# Graph Report - obrez-ts  (2026-07-09)

## Corpus Check
- 75 files · ~112,594 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 497 nodes · 708 edges · 57 communities (41 shown, 16 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 11 edges (avg confidence: 0.88)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4f29a338`
...
Cohesion: 0.10
Nodes (24): BleepSoundManager, DebugButton(), ErrorEntry, DEFAULT_DICTIONARIES, DictionaryManager, Window, SettingsModal(), SettingsModalProps (+16 more)
...
Cohesion: 0.07
Nodes (26): ConfirmationModal(), ConfirmationModalProps, formatDuration(), LoginModal(), formatSeconds(), PACKAGES, TopupModal(), TopupModalProps (+18 more)
...
## Knowledge Gaps
- **202 isolated node(s):** `LoginModalProps`, `DEFAULT_DICTIONARIES`, `AuthStore`, `Key Facts`, `Documentation` (+197 more)
...
- **What connects `LoginModalProps`, `DEFAULT_DICTIONARIES`, `AuthStore` to the rest of the system?**
