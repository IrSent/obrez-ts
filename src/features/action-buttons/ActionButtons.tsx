...
import { useIsLandscape } from '../../hooks/useMobileLandscape';
        ...
        <div className="relative bg-zinc-800 rounded-xl shadow-[0_25px_80px_rgba(0,0,0,0.7),0_14px_40px_rgba(0,0,0,0.5),0_5px_16px_rgba(0,0,0,0.35),0_0_0_1px_rgba(113,113,122,0.5)]">
          ...
          <div className="flex items-stretch">
            ...
            {exporting && exportProgress && (
              <span className="text-[9px] text-yellow-400 tabular-nums flex items-center px-2 flex-shrink-0">
      ...
      {isLandscape && (
        <div className="relative bg-zinc-800/80 backdrop-blur-sm rounded-lg">
          <div className="flex items-stretch">
            ...
            <Divider />
            <CompactBtn icon={<DownloadIcon />} label="Export" disabled={!hasTranscription} onClick={() => { setExportError(null); setShowExportModal(true); }} />
